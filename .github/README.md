...
- A cool button to generate Rand stuff

## How It Works

1. You click the button.
2. You get Rand stuff
3. Enjoy!
...
Contributions are welcome. Please check [CONTRIBUTING.md](CONTRIBUTING.md) for technical details and setup instructions, trust me they are hella hard to setup so you must read else don't blame me when you fail to run html.
